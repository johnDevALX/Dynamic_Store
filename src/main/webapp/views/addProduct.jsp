...
<section id="form">
    <div class="container-lg my-5">
        <div class="text-center">
            <h2>Welcome To The Add Product Dashboard</h2>
            <p class="lead">Enter Product Details</p>
        </div>
        <div class="row justify-content-center mb-2">
            <div class=" col-9 col-lg-4 border border-secondary rounded py-3">
                <form action="ProductController" method="post">
                    <div class="input-group mb-2">
                        <span class="input-group-text btn btn-primary" id="basic-addon1"><i class="fa fa-book"></i></span>
                        <input type="text" class="form-control" name="productName" placeholder="Product name" aria-label="Product name" aria-describedby="basic-addon1"  required/>
                    </div>
                    <div class="input-group mb-2">
                        <span class="input-group-text btn btn-primary" id="basic-addon7"><i class="fa fa-money"></i></span>
                        <input type="text" class="form-control" name="price" placeholder="Price" aria-label="Price" aria-describedby="basic-addon7" required/>
                    </div>
                    <div class="input-group mb-2">
                        <span class="input-group-text btn btn-primary" id="basic-addon3"><i class="bi bi-list-check"></i></span>
                        <input type="text" class="form-control" name="quantity" placeholder="Quantity" aria-label="Quantity" aria-describedby="basic-addon3" required/>
                    </div>
        ...
        <div class="row justify-content-center mt-5">
            <div class="col-lg-6 col-xl-3">
              <span class="aa" data-bs-placement="bottom" title="we are happy to serve you">
                <img src="/assets/back2.png" width="100" class="my-5 ms-5" alt="Man">
              </span>
            </div>
