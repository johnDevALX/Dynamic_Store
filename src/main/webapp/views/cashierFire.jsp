...
<section id="form">
    <div class="container-lg">
        <div class="text-center">
            <h2>Cashier Contract Termination Portal</h2>
            <p class="lead">Enter The Details Of Employee To Be Fired</p>
        </div>
        <div class="row justify-content-center mb-2">
            <div class="col-9 col-lg-4 border border-secondary rounded py-3">
                <form action="${pageContext.request.contextPath}/cashierFireControllerServlet" method="post">
