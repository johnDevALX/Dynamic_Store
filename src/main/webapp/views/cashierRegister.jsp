...
<head>
    ...
    <title>Applicant Application Form</title>
    <style>
        body{
            background: #f3efe7;
        }
    ...
    <div class="container-lg">
        ...
        <div class="row justify-content-center mb-2">
            <div class="col-9 col-lg-4 border border-secondary rounded py-3">
                <form action="${pageContext.request.contextPath}/cashierHireControllerServlet" method="post">
                    ...
                    <div class="input-group mb-2">
                        <span class="input-group-text btn btn-primary" id="basic-addon8"><i class="fa fa-list-ol" aria-hidden="true"></i></span>
                        <input type="text" class="form-control" name="age" placeholder="Age" aria-label="age" aria-describedby="basic-addon8" required/>
                    </div>
                    <div class="input-group mb-2">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="text" class="form-control" name="yearsOfExp" placeholder="Id" aria-label="id" aria-describedby="basic-addon7" required/>
                    </div>
