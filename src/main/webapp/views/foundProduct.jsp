<%@ page import="com.ekene.store.models.Product" %><%--
...
<nav class="navbar navbar-expand-md mb-5" style="background: #FFF0A0;">
    <div class="container-lg">
        ...
        <div class="collapse navbar-collapse justify-content-end align-center" id="main-nav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="#"><i style="margin-right: 5px;" class="fa fa-home" aria-hidden="true"></i>Home</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" style="background: #FFF0A0;">
                            ...
                            <li><a class="dropdown-item" href="#">Cashier Dashboard</a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
    ...
    <div class="container-9">
        <div class="row justify-content-center mb-5">
            <div class="col-lg-10 my-3 me-2">
                <h2 class="text-black">Product Details</h2>
                <form action="${pageContext.request.contextPath}/searchProductCtrl" class="lead mb-1">
                    <%
                        Product product = (Product) request.getAttribute("product");
                            out.println("<p class='lead text-black'><b> Product Id: " + product.getProductId() + "</b></p>");
                            out.println("<p class='lead text-black'><b> Product Name: " + product.getProductName() + "</b></p>");
                            out.println("<p class='lead text-black'><b> Product Price: " + product.getPrice() + "</b></p>");
                            out.println("<p class='lead text-black'><b> Product Quantity: " + product.getQuantity() + "</b></p>");
                    %>
                </form>
                <a href="StoreServlet" class="btn btn-outline-secondary m-3">Home</a>
            </div>
        </div>
    </div>
