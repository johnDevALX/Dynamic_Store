...
<div class="container-lg">
    <div class="row justify-content-center m-5 ">
        <div class="col-9 col-lg-6 border border-secondary rounded py-3 ">
            <h3 class="lead fw-bold text-center ">Successfully Login To DashBoard</h3>
            <p class="text-center" >Proceed with other activities.</p>

            <a href="${pageContext.request.contextPath}/cashierHireControllerServlet" class="btn btn-outline-success m-3">Hire Cashier</a>
            <a href="${pageContext.request.contextPath}/cashierFireControllerServlet" class="btn btn-outline-danger m-3">Fire Cashier</a>
            <a href="ProductController" class="btn btn-outline-info m-3">Add Product</a>
            <a href="displayProductCtrl" class="btn btn-outline-info m-3">Check All Product</a>
        </div>
    </div>
</div>
