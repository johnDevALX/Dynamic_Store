            ...
            <div class="col-9 col-lg-4 border border-secondary rounded py-3">
                <form action="${pageContext.request.contextPath}/managerLoginController" method="post">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="text" class="form-control" name="mgrId" placeholder="Id" aria-label="id" aria-describedby="basic-addon7" required/>
                    </div>
