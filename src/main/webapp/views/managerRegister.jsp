...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Montserrat+Alternates:wght@300&family=PT+Serif&display=swap" rel="stylesheet">
    ...
    <section id="form">
        <div class="container-lg">
            <div class="text-center">
                ...
                <p class="lead">Fill In Your Details</p>
            </div>
            <div class="row justify-content-center mb-5">
                <div class="col-9 col-lg-4">
                    <form action="${pageContext.request.contextPath}/ManagerControllerServlet" method="post">
                        ...
                        <div class="input-group mb-3">
                            <span class="input-group-text btn btn-primary" id="basic-addon2"><i class="bi bi-person-circle"></i></span>
                            <input type="text" class="form-control" name="lastName" placeholder="lastName" aria-label="lastName" aria-describedby="basic-addon2" required/>
                        </div>
                        <div class="input-group mb-3">
                            <span class="input-group-text btn btn-primary" id="basic-addon3"><i class="bi bi-gender-ambiguous"></i></span>
                            <input type="text" class="form-control" name="gender" placeholder="gender" aria-label="gender" aria-describedby="basic-addon3" required/>
                        </div>
                        <div class="input-group mb-3">
                            <span class="input-group-text btn btn-primary" id="basic-addon4"><i class="bi bi-envelope-at-fill"></i></span>
                            <input type="email" class="form-control" name="email" placeholder="email" aria-label="email" aria-describedby="basic-addon4" required/>
                        </div>
                        <div class="input-group mb-3">
                            <span class="input-group-text btn btn-primary" id="basic-addon5"><i class="bi bi-currency-dollar"></i></span>
                            <input type="text" class="form-control" name="salary" placeholder="salary" aria-label="salary" aria-describedby="basic-addon5" required/>
                        </div>
                        <div class="input-group mb-3">
                            <span class="input-group-text btn btn-primary" id="basic-addon6"><i class="bi bi-person-workspace"></i></span>
                            <input type="text" class="form-control" name="role" placeholder="role" aria-label="role" aria-describedby="basic-addon6" required/>
                        </div>
                        <div class="input-group mb-3">
                            <span class="input-group-text btn btn-primary" id="basic-addon7"><i class="bi bi-person-badge"></i></span>
                            <input type="text" class="form-control" name="id" placeholder="id" aria-label="id" aria-describedby="basic-addon7" required/>
                        </div>
                        <div class="mb-4 text-center">
                            <input class="btn btn-outline-primary" type="submit" value="Submit"/>
                            <a href="managerLoginController" class="mx-3 btn btn-outline-primary">Login</a>
                        </div>
