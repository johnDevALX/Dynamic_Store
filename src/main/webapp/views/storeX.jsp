    ...
    <div class="container-lg">
        ...
        <div class="collapse navbar-collapse justify-content-end align-center" id="main-nav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#Help"><i style="margin-right: 5px;" class="fa fa-phone" aria-hidden="true"></i>Contact</a>
                </li>
...
<h2 class="text-center mb-5 fw-bold">WELCOME TO StoreX, YOUR BEST SHOP FOR THRIFT SHOPPING <i class="bi bi-stars"></i></h2>
<div class="container-lg" id="intro">
    <div class="text-center">
        <h2>Product Details</h2>
        <p class="lead text-muted">Read through and purchase our quality product</p>
    </div>
    <div class="row justify-content-center align-items-center">
        <div class="col-md-5 text-center text-md-start mb-5">
            <h4>
                <div class="display-5">Office Chair</div>
                <div class="text-muted">Executive Star Black</div>
            </h4>
            <p class="lead my-4 text-muted">Adjustable chairs designed specifically for performing desk tasks. Typically designed with high degree of adjustability based on individual ergonomic preferences and the height and stature of the user.</p>
            <p class="display-5 my-4 text-primary fw-bold">$23.99</p>
            <a href="#" class="btn btn-secondary">Buy Now</a> <br>
            <a href="moreChairsServlet" class=" btn btn-outline-primary mt-3">See More</a>
        </div>
        <div class="col-md-5 text-center d-none d-md-block mb-5">
            <img src="./assets/office.jpg" alt="Banana" class="img-fluid" width="80%">
        </div>

        <div class="col-md-5 text-center text-md-start mb-5">
            <h4>
                <div class="display-5">Office Table</div>
                <div class="text-muted">Premium Star Black</div>
            </h4>
            <p class="lead my-4 text-muted">Adjustable Tables designed specifically for performing desk tasks. Typically designed with high degree of adjustability based on individual ergonomic preferences and the height and stature of the user.</p>
            <p class="display-5 my-4 text-primary fw-bold">$43.99</p>
            <a href="#" class="btn btn-secondary">Buy Now</a> <br>
            <a href="moreTablesServlet" class=" btn btn-outline-primary mt-3">See More</a>
        </div>
        <div class="col-md-5 text-center d-none d-md-block mb-5">
            <img src="./assets/table.jpg" alt="Banana" class="img-fluid" width="80%">
        </div>
    </div>

    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sit quasi aspernatur ex perferendis iusto eaque, porro dicta? Obcaecati vel velit eveniet id sed, dolorum labore perferendis iste recusandae doloribus error.</p>
        ...
        <div class="row justify-content-center my-3">
            <div class="col-lg-6 col-xl-3">
              <span class="aa" data-bs-placement="bottom" title="we are happy to serve you">
                <img src="./assets/back3.jpg" width="100" class="my-5 ms-5" alt="Image">
              </span>
            </div>
            ...
            <div class="col-lg-6 col-xl-2 my-3">
                <div class="bravo">
                    ...
                    <a href="#" class="fw-light m-2 text-muted  d-flex" style="text-decoration: none;">Add Account</a>
